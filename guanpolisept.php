...
<head>
  ...
  <link rel="shortcut icon" href="/Images/webicon.png" type="image/x-icon">
	<title>
	ТОВ ТВД "РІВС" | Головна сторінка | Офіційний сайт продукту Гуанполісепт
	</title>
  <meta charset="utf-8">
...
<!--Main Navigation-->
  ...
  <main class="mt-5 mb-3">
      ...
      <p>
      Дезінфікуючий засіб ГУАНПОЛІСЕПТ відноситься до дезінфектантів нового покоління (полімерні гуанідинові антисептичні препарати), що не містить активного хлору, альдегідів і випускається у вигляді 15% -ного водного розчину, що представляє собою прозору безбарвну рідину без запаху з необмеженою розчинністю у воді.
      <p>
