    ...
    if (hash_equals($verification_token, $verification_token1) && hash_equals($security_token, $security_token1)) {
        ...
        $user_data_html = sprintf(
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <label for="checkout_first_name" class=>Им%1$sя</label>
                    <input type="text" readonly="true" class="form-control text-body" id="checkout_first_name" value="%5$s">
                </div>
                <div class="col-sm-4">
                    <label for="checkout_middle_name" class=>Им%1$sя отчество</label>
    ...
    if (hash_equals($verification_token, $verification_token1)) {
        ...
        $user_data_html = sprintf(
            ...
            <div class="form-row">
                ...
                <div class="form-group col-sm-4">
                    <label for="checkout_first_name" class=>Им%1$sя</label>
                    <input type="text" class="form-control" id="checkout_first_name" placeholder="Введите им%1$sя" required>
                    <div id="checkout_first_name_feedback" class="invalid-feedback"></div>
                </div>
                <div class="form-group col-sm-4">
                    <label for="checkout_middle_name" class=>Им%1$sя отчество</label>
                    <input type="text" class="form-control" id="checkout_middle_name" placeholder="Введите им%1$sя отчество" required>
...
$cart_modal_html .= sprintf(
    '<div class="row">
        <div class="col-md-12 pr-3 py-2 pl-2">          
            ...
            <div class="h2 mb-0 font-weight-normal px-3 py-2 float-right">Итого:</div>
        </div>
    </div>',
