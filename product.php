        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
          ...
          <ul class="navbar-nav navbar-right">
            <li class="nav-item dropdown">
              ...
              <a class="nav-link dropdown-toggle" data-toggle="modal" data-target="#MobileModal">
                <i class="fas fa-phone"></i>+38(067)406-11-92
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="https://www.rivs.com.ua/ru/product<?= $PRODUCT['ProductName']; ?>">RU
                <span class="sr-only">(current)</span>
              </a>
              <i class="russia flag"></i>
            </li>
            <li class="nav-item active disabled">
              <a class="nav-link" href="https://www.rivs.com.ua/product">UA
                <span class="sr-only">(current)</span>
              </a>
            </li>
          </ul>
