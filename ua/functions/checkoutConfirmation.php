...
if ($is_authorized) {
    ...
    if (hash_equals($verification_token, $verification_token1) && hash_equals($security_token, $security_token1)) {
        ...
        if ($stmt = $mysqli->prepare("INSERT INTO `orders_in_process` (`UserID`, `Date`) VALUES (?, ?)")) {
            $stmt->bind_param("is", $userID, date('Y-m-d H:i:s', time()));
                                    ...
                                    <tr style="box-sizing: border-box;">
                                        <td style="box-sizing: border-box;">
                                            <div
                                                ...
                                                Дякуємо за замовлення в інтернет-магизині</div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
